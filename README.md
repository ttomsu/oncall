...
### Prerequisites
  ...
  * Debian/Ubuntu - `sudo apt-get install -y libsasl2-dev python-dev libldap2-dev libssl-dev python-pip python-setuptools mysql-server mysql-client libffi-dev libyaml-cpp-dev python-dateutil`
